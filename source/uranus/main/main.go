...
// ./uranus --method=example  --root=.
// ./uranus --method=generate --config=./example-shard-config.json --root=./mytestnet
// ./uranus --method=start --root=./mytestnet --start-time=0:53  --wait-time="20s"

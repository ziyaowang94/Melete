...
// ./melete --method=example  --root=.
// ./melete --method=generate --config=./example-shard-config.json --root=./mytestnet
// ./melete --method=start --root=./mytestnet --start-time=0:53  --wait-time="20s"

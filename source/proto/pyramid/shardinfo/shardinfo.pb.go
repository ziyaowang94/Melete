...
var file_proto_pyramid_shardinfo_shardinfo_proto_goTypes = []interface{}{
...
func file_proto_pyramid_shardinfo_shardinfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pyramid_shardinfo_shardinfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_pyramid_shardinfo_shardinfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_pyramid_shardinfo_shardinfo_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
